...
class _ExamPageState extends State<ExamPage> with WidgetsBindingObserver {
  ...
  Color get _bg => AppColors.background(context);
  Color get _surface => AppColors.surface(context);
  Color get _surface2 => AppColors.surface2(context);
  Color get _deep => AppColors.textPrimary(context);
  Color get _muted => AppColors.textSecondary(context);
  Color get _line => AppColors.borderSoft(context);
  ...
  void _finishAndExit() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      Navigator.of(context).pushAndRemoveUntil(
        MaterialPageRoute(
          builder: (_) => const StructurePage(initialIndex: 0),
        ),
        (_) => false,
      );
    });
        ...
        return Padding(
          ...
          child: InkWell(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: checked ? _primary.withOpacity(0.08) : _surface,
                borderRadius: BorderRadius.circular(18),
                border: Border.all(
            ...
            Expanded(
              child: OutlinedButton.icon(
                ...
                style: OutlinedButton.styleFrom(
                  ...
                  backgroundColor:
                      reviewed ? const Color(0xFFFFF7EA) : _surface,
                  padding: const EdgeInsets.symmetric(vertical: 14),
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(15),
                  ),
  ...
  Widget _legendDot({
    ...
    final resolvedTextColor = textColor ?? _muted;
    return Row(
      mainAxisSize: MainAxisSize.min,
      children: [
        Container(
